...
RESULTS_DIR = 'E:\\NEW MIET\\Raw Results\\CSE'
...
StartRoll = 2000680100001
EndRoll = 2000680100377
...
def generate_filenames(range_start, range_end):
    ...
    try:
        ...
        #removed due to some error (particular reasons in notes file)
        filenames.remove('2000680100084')
        filenames.remove('2000680100267')
        filenames.remove('2000680100030')
        filenames.remove('2000680100090')
        filenames.remove('2000680100119')
        filenames.remove('2000680100124')
