...
RESULTS_DIR = 'E:\\NEW MIET\\Raw Results\\DS'
...
StartRoll = 2000681540001
EndRoll = 2000681540050
...
def generate_filenames(range_start, range_end):
    ...
    try:
        ...
        filenames.remove('2000681540046')
        filenames.remove('2000681540043')
        filenames.remove('2000681540010')
